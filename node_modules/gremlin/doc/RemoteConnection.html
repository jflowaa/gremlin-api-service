...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="submit"><span class="type-signature">(abstract) </span>submit<span class="signature">(bytecode)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="param-desc">
    Returns a <code>Promise</code> that resolves to a <code>RemoteTraversal</code>.
</div>
