...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: RemoteTraversal</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: RemoteTraversal</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>RemoteTraversal<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Represents a traversal as a result of a <a href="RemoteConnection.html">RemoteConnection</a> submission.</div>
...
<article>
    ...
    <h4 class="name" id="RemoteTraversal"><span class="type-signature"></span>new RemoteTraversal<span class="signature">()</span><span class="type-signature"></span></h4>
