...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SaslMechanismPlain</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SaslMechanismPlain</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>SaslMechanismPlain<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="SaslMechanismPlain"><span class="type-signature"></span>new SaslMechanismPlain<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The mechanism options.
                <h6>Properties</h6>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The identity of the client.</td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The identity of user with access to server.</td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The password of user with access to server.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="driver_auth_mechanisms_sasl-mechanism-plain.js.html">driver/auth/mechanisms/sasl-mechanism-plain.js</a>, <a href="driver_auth_mechanisms_sasl-mechanism-plain.js.html#line32">line 32</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <h4 class="name" id="_hasInitialResponse"><span class="type-signature"></span>_hasInitialResponse<span class="signature">(challenge)</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The challenge string from the server.</td>
        </tr>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id="_saslArgument"><span class="type-signature"></span>_saslArgument<span class="signature">(authzid, username, password)</span><span class="type-signature"></span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">Identitiy of the client.</td>
        </tr>
...
<dl class="details">
    ...
    <h4 class="name" id="evaluateChallenge"><span class="type-signature"></span>evaluateChallenge<span class="signature">(challenge)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">Challenge string presented by the server.</td>
        </tr>
