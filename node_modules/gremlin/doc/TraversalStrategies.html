...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: TraversalStrategies</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: TraversalStrategies</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>TraversalStrategies<span class="signature">(parent<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="TraversalStrategies"><span class="type-signature"></span>new TraversalStrategies<span class="signature">(parent<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="TraversalStrategies.html">TraversalStrategies</a></span>
            ...
            <td class="description last">The parent strategies from where to clone the values from.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="process_traversal-strategy.js.html">process/traversal-strategy.js</a>, <a href="process_traversal-strategy.js.html#line33">line 33</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="addStrategy"><span class="type-signature"></span>addStrategy<span class="signature">(strategy)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="TraversalStrategy.html">TraversalStrategy</a></span>
...
<dl class="details">
    ...
    <h4 class="name" id="applyStrategies"><span class="type-signature"></span>applyStrategies<span class="signature">(traversal)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="process_traversal-strategy.js.html">process/traversal-strategy.js</a>, <a href="process_traversal-strategy.js.html#line52">line 52</a>
    </li></ul></dd>
