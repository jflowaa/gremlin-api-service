...
-->
<h1>JavaScript Gremlin Language Variant</h1><p><a href="http://tinkerpop.apache.org">Apache TinkerPop™</a> is a graph computing framework for both graph databases (OLTP) and graph analytic systems
...
<pre class="prettyprint source lang-bash"><code>npm install gremlin</code></pre><p>Please see the <a href="http://tinkerpop.apache.org/docs/current/reference/#gremlin-javascript">reference documentation</a> at Apache TinkerPop for more information.</p>
